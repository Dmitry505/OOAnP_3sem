using Hwdtech;
using Hwdtech.Ioc;
using Dct = System.Collections.Generic.Dictionary<int, object>;
...
public class BuildTreeTests
{
    ...
    public void BuildCollisionTreeCommand_Positive()
    {
        ...
        var tree = IoC.Resolve<Dct>("Game.Collisions.Tree");

        var real_layer_1 = tree.Keys;
        var real_layer_2 = ((Dct)tree[1]).Keys.Union(((Dct)tree[6]).Keys);
        var real_layer_3 = ((Dct)((Dct)tree[1])[2]).Keys.Union(((Dct)((Dct)tree[6])[7]).Keys);
        var real_layer_4 = ((Dct)((Dct)((Dct)tree[1])[2])[3]).Keys.Union(((Dct)((Dct)((Dct)tree[6])[7])[8]).Keys);
